...
// node_modules/vue3-youtube/dist/vue3-youtube.umd.js
var require_vue3_youtube_umd = __commonJS({
  "node_modules/vue3-youtube/dist/vue3-youtube.umd.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
        ...
        exports["vue3-youtube"] = factory(require_vue());
      else
        root["vue3-youtube"] = factory(root["Vue"]);
        ...
        function(modules) {
          ...
          "fb15": (
            ...
            function(module2, __webpack_exports__, __webpack_require__) {
              ...
              var get_youtube_id = __webpack_require__("9fab");
              var get_youtube_id_default = __webpack_require__.n(get_youtube_id);
              var PlayerState = {
                UNSTARTED: -1,
                ENDED: 0,
                PLAYING: 1,
              ...
              var YouTube = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
                name: "YouTube",
                props: {
                  src: {
                    type: String,
                ...
                computed: {
                  id: function id() {
                    return get_youtube_id_default()(this.src) || this.src;
                  },
                ...
                mounted: function mounted() {
                  ...
                  var id = "youtube-iframe-js-api-script";
                ...
                methods: {
                   ...
                   */
                  cueVideoById: function cueVideoById(videoId, startSeconds, suggestedQuality) {
                    var _this$player;
                    (_this$player = this.player) === null || _this$player === void 0 ? void 0 : _this$player.cueVideoById(videoId, startSeconds, suggestedQuality);
                  },
                  /**
                   ...
                   * @param suggestedQuality   Suggested video player quality.
                   */
                  loadVideoById: function loadVideoById(videoId, startSeconds, suggestedQuality) {
                    var _this$player2;
                    (_this$player2 = this.player) === null || _this$player2 === void 0 ? void 0 : _this$player2.loadVideoById(videoId, startSeconds, suggestedQuality);
                  },
                  /**
                   ...
                   * @param suggestedQuality   Suggested video player quality.
                   */
                  cueVideoByUrl: function cueVideoByUrl(mediaContentUrl, startSeconds, suggestedQuality) {
                    var _this$player3;
                    (_this$player3 = this.player) === null || _this$player3 === void 0 ? void 0 : _this$player3.cueVideoByUrl(mediaContentUrl, startSeconds, suggestedQuality);
                  },
                  /**
                   ...
                   * @param suggestedQuality   Suggested video player quality.
                   */
                  loadVideoByUrl: function loadVideoByUrl(mediaContentUrl, startSeconds, suggestedQuality) {
                    var _this$player4;
                    (_this$player4 = this.player) === null || _this$player4 === void 0 ? void 0 : _this$player4.loadVideoByUrl(mediaContentUrl, startSeconds, suggestedQuality);
                  },
                  /**
                   ...
                   * @param suggestedQuality   Suggested video player quality.
                   */
                  cuePlaylist: function cuePlaylist(playlist, index, startSeconds, suggestedQuality) {
                    var _this$player5;
                    (_this$player5 = this.player) === null || _this$player5 === void 0 ? void 0 : _this$player5.cuePlaylist(playlist, index, startSeconds, suggestedQuality);
                  },
                  /**
                   ...
                   * @param suggestedQuality   Suggested video player quality.
                   */
                  loadPlaylist: function loadPlaylist(playlist, index, startSeconds, suggestedQuality) {
                    var _this$player6;
                    (_this$player6 = this.player) === null || _this$player6 === void 0 ? void 0 : _this$player6.loadPlaylist(playlist, index, startSeconds, suggestedQuality);
                  },
                  /**
                  ...
                  playVideo: function playVideo() {
                    var _this$player7;
                    (_this$player7 = this.player) === null || _this$player7 === void 0 ? void 0 : _this$player7.playVideo();
                  },
                  /**
                  ...
                  pauseVideo: function pauseVideo() {
                    var _this$player8;
                    (_this$player8 = this.player) === null || _this$player8 === void 0 ? void 0 : _this$player8.pauseVideo();
                  },
                  /**
                  ...
                  stopVideo: function stopVideo() {
                    var _this$player9;
                    (_this$player9 = this.player) === null || _this$player9 === void 0 ? void 0 : _this$player9.stopVideo();
                  },
                  /**
                  ...
                  seekTo: function seekTo(seconds, allowSeekAhead) {
                    var _this$player10;
                    (_this$player10 = this.player) === null || _this$player10 === void 0 ? void 0 : _this$player10.seekTo(seconds, allowSeekAhead);
                  },
                  /**
                  ...
                  nextVideo: function nextVideo() {
                    var _this$player11;
                    (_this$player11 = this.player) === null || _this$player11 === void 0 ? void 0 : _this$player11.nextVideo();
                  },
                  /**
                  ...
                  previousVideo: function previousVideo() {
                    var _this$player12;
                    (_this$player12 = this.player) === null || _this$player12 === void 0 ? void 0 : _this$player12.previousVideo();
                  },
                  /**
                   ...
                   */
                  playVideoAt: function playVideoAt(index) {
                    var _this$player13;
                    (_this$player13 = this.player) === null || _this$player13 === void 0 ? void 0 : _this$player13.playVideoAt(index);
                  },
                  /**
                   * Mutes the player.
                   */
                  mute: function mute() {
                    var _this$player14;
                    (_this$player14 = this.player) === null || _this$player14 === void 0 ? void 0 : _this$player14.mute();
                  },
                  /**
                   * Unmutes the player.
                   */
                  unMute: function unMute() {
                    var _this$player15;
                    (_this$player15 = this.player) === null || _this$player15 === void 0 ? void 0 : _this$player15.unMute();
                  },
                  /**
                  ...
                  setVolume: function setVolume(volume) {
                    var _this$player16;
                    (_this$player16 = this.player) === null || _this$player16 === void 0 ? void 0 : _this$player16.setVolume(volume);
                  },
                  /**
                  ...
                  setPlaybackRate: function setPlaybackRate(suggestedRate) {
                    var _this$player17;
                    (_this$player17 = this.player) === null || _this$player17 === void 0 ? void 0 : _this$player17.setPlaybackRate(suggestedRate);
                  },
                  /**
                   ...
                   */
                  setLoop: function setLoop(loopPlaylists) {
                    var _this$player18;
                    (_this$player18 = this.player) === null || _this$player18 === void 0 ? void 0 : _this$player18.setLoop(loopPlaylists);
                  },
                  /**
                   ...
                   */
                  setShuffle: function setShuffle(shufflePlaylist) {
                    var _this$player19;
                    (_this$player19 = this.player) === null || _this$player19 === void 0 ? void 0 : _this$player19.setShuffle(shufflePlaylist);
                  },
                  /**
                   * @returns A number between 0 and 1 of how much the player has buffered.
                   */
                  getVideoLoadedFraction: function getVideoLoadedFraction() {
                  ...
                  setPlaybackQuality: function setPlaybackQuality(suggestedQuality) {
                    var _this$player20;
                    (_this$player20 = this.player) === null || _this$player20 === void 0 ? void 0 : _this$player20.setPlaybackQuality(suggestedQuality);
                  },
                  /**
                   * @returns Quality formats in which the current video is available.
                   */
                  getAvailableQualityLevels: function getAvailableQualityLevels() {
                   ...
                   */
                  getVideoEmbedCode: function getVideoEmbedCode() {
                ...
                watch: {
                  width: function width() {
                    var _this$player21;
                    (_this$player21 = this.player) === null || _this$player21 === void 0 ? void 0 : _this$player21.setSize(+this.width, +this.height);
                  },
                  height: function height() {
                    var _this$player22;
                    (_this$player22 = this.player) === null || _this$player22 === void 0 ? void 0 : _this$player22.setSize(+this.width, +this.height);
                  },
                  src: function src2() {
                ...
                beforeUnmount: function beforeUnmount() {
                  var _this$player23;
                  (_this$player23 = this.player) === null || _this$player23 === void 0 ? void 0 : _this$player23.destroy();
                }
              });
              var YouTubevue_type_script_lang_ts = YouTube;
              YouTubevue_type_script_lang_ts.render = render;
              var src_YouTube = YouTubevue_type_script_lang_ts;
              var entry_lib = __webpack_exports__["default"] = src_YouTube;
            }
          ),
          /***/
          "fc6a": (
...
export default require_vue3_youtube_umd();
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=vue3-youtube.js.map
