  ...
  "node_modules/bootstrap/dist/js/bootstrap.bundle.min.js"(exports, module) {
    !function(t, e) {
      ...
      class Lt extends W {
        ...
        to(t2) {
          ...
          if (t2 > e2.length - 1 || t2 < 0)
            return;
          if (this._isSliding)
            return void N.one(this._element, pt, () => this.to(t2));
        ...
        _addTouchEventListeners() {
          for (const t3 of z.find(".carousel-item img", this._element))
            N.on(t3, bt, (t4) => t4.preventDefault());
      ...
      N.on(document, yt, "[data-bs-slide], [data-bs-slide-to]", function(t2) {
        ...
        if (!e2 || !e2.classList.contains(wt))
          return;
        t2.preventDefault();
      ...
      class Rt extends W {
        ...
        hide() {
          if (this._isTransitioning || !this._isShown())
            return;
          if (N.trigger(this._element, It).defaultPrevented)
            return;
      ...
      function Ne(t2) {
        for (var e2 = me(t2), i2 = Ie(t2); i2 && Se(i2) && "static" === Le(i2).position; )
          i2 = Ie(i2);
        return i2 && ("html" === pe(i2) || "body" === pe(i2) && "static" === Le(i2).position) ? e2 : i2 || function(t3) {
          var e3 = /firefox/i.test(Te());
          if (/Trident/i.test(Te()) && _e(t3) && "fixed" === Le(t3).position)
            return null;
          var i3 = $e(t3);
      ...
      class Ki extends W {
        ...
        _getConfig(t2) {
          if ("object" == typeof (t2 = super._getConfig(t2)).reference && !o(t2.reference) && "function" != typeof t2.reference.getBoundingClientRect)
            throw new TypeError(`${Ai.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
          return t2;
        }
        _createPopper() {
          if (void 0 === wi)
      ...
      class kn extends W {
        ...
        _triggerBackdropTransition() {
          if (N.trigger(this._element, pn).defaultPrevented)
            return;
      ...
      N.on(document, zn, '[data-bs-toggle="offcanvas"]', function(t2) {
        ...
        for (const t2 of z.find(Pn))
          Kn.getOrCreateInstance(t2).show();
      }), N.on(window, Bn, () => {
        for (const t2 of z.find("[aria-modal][class*=show][class*=offcanvas-]"))
          "fixed" !== getComputedStyle(t2).position && Kn.getOrCreateInstance(t2).hide();
      }), R(Kn), m(Kn);
      ...
      class ts extends H {
        ...
        _checkContent(t2) {
          for (const [e2, i2] of Object.entries(t2))
            super._typeCheckConfig({ selector: e2, entry: i2 }, Zn);
        }
        ...
        _maybeSanitize(t2) {
          return this._config.sanitize ? function(t3, e2, i2) {
            ...
            for (const t4 of s2) {
              ...
              for (const e3 of n3)
                Un(e3, s3) || t4.removeAttribute(e3.nodeName);
            }
      ...
      class us extends W {
        ...
        show() {
          ...
          if (this._element.ownerDocument.documentElement.contains(this.tip) || (n2.append(i2), N.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i2), i2.classList.add(ns), "ontouchstart" in document.documentElement)
            for (const t3 of [].concat(...document.body.children))
              N.on(t3, "mouseover", h);
          this._queueCallback(() => {
      ...
      class ks extends W {
        ...
        _activateParents(t2) {
          if (t2.classList.contains("dropdown-item"))
            z.findOne(".dropdown-toggle", t2.closest(".dropdown")).classList.add(As);
          else
            for (const e2 of z.parents(t2, ".nav, .list-group"))
              for (const t3 of z.prev(e2, Cs))
                t3.classList.add(As);
        }
      ...
      class Gs extends W {
        ...
        _keydown(t2) {
          if (![Ms, Fs, Hs, Ws, Bs, zs].includes(t2.key))
            return;
          t2.stopPropagation(), t2.preventDefault();
          const e2 = this._getChildren().filter((t3) => !l(t3));
          let i2;
          if ([Bs, zs].includes(t2.key))
            i2 = e2[t2.key === Bs ? 0 : e2.length - 1];
          else {
      ...
      N.on(document, Ns, Xs, function(t2) {
        ...
        for (const t2 of z.find(Us))
          Gs.getOrCreateInstance(t2);
      }), m(Gs);
