...
var require_v_click_outside_umd = __commonJS({
  "node_modules/v-click-outside/dist/v-click-outside.umd.js"(exports, module) {
    !function(e, n) {
      ...
      var e = "__v-click-outside", n = "undefined" != typeof window, t = "undefined" != typeof navigator, r = n && ("ontouchstart" in window || t && navigator.msMaxTouchPoints > 0) ? ["touchstart"] : ["click"];
      function i(e2) {
      ...
      function a(n2, t2) {
        var a2 = function(e2) {
          ...
          return { handler: n3 ? e2 : e2.handler, middleware: e2.middleware || function(e3) {
            return e3;
          }, events: e2.events || r, isActive: !(false === e2.isActive), detectIframe: !(false === e2.detectIframe), capture: !!e2.capture };
        }(t2.value), d2 = a2.handler, o2 = a2.middleware, c = a2.detectIframe, u = a2.capture;
        if (a2.isActive) {
          if (n2[e] = a2.events.map(function(e2) {
            return { event: e2, srcTarget: document.documentElement, handler: function(e3) {
              return function(e4) {
                var n3 = e4.el, t3 = e4.event, r2 = e4.handler, a3 = e4.middleware, d3 = t3.composedPath && t3.composedPath() || t3.path;
                (d3 ? d3.indexOf(n3) < 0 : !n3.contains(t3.target)) && i({ event: t3, handler: r2, middleware: a3 });
              }({ el: n2, event: e3, handler: d2, middleware: o2 });
            }, capture: u };
          }), c) {
            var l = { event: "blur", srcTarget: window, handler: function(e2) {
              ...
              }({ el: n2, event: e2, handler: d2, middleware: o2 });
            }, capture: u };
            n2[e] = [].concat(n2[e], [l]);
          }
      ...
      var o = n ? { bind: a, update: function(e2, n2) {
        var t2 = n2.value, r2 = n2.oldValue;
        JSON.stringify(t2) !== JSON.stringify(r2) && (d(e2), a(e2, { value: t2 }));
      }, unbind: d } : {};
      return { install: function(e2) {
        e2.directive("click-outside", o);
      }, directive: o };
    });
  }
});
