  ...
  <header id="page-topbar">
    <div class="navbar-header">
      <div class="d-flex">
        ...
        <BDropdown dropend variant="white" class="dropdown-mega d-none d-lg-block ms-2" toggle-class="header-item" menu-class="dropdown-megamenu">
          <template #button-content> {{ $t("navbar.dropdown.megamenu.text") }}
            <i class="mdi mdi-chevron-down"></i> </template>
          <div class="row">
            <div class="col-sm-8">
              <div class="row">
                <div class="col-md-4">
      ...
      <div class="d-flex">
        ...
        <BDropdown variant="white" class="d-none d-lg-inline-block d-lg-inline-block ms-1" menu-class="dropdown-menu-lg" right toggle-class="header-item noti-icon">
