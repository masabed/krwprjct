  ...
  <div>
    ...
    <div v-click-outside="config" class="right-bar">
      <simplebar class="h-100">
        ...
        <div class="p-4">
          <div class="mb-2">
            <router-link to="http://nazox.vuejs-light-h.themesdesign.in/" target="_blank">
              <img src="@/assets/images/layouts/layout-4.jpg" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>

          <div class="mb-2">
            <router-link to="http://nazox.vuejs-dark-h.themesdesign.in/" target="_blank">
              <img src="@/assets/images/layouts/layout-5.jpg" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>

          <div class="mb-2">
            <router-link to="http://nazox.vuejs-rtl-h.themesdesign.in/" target="_blank">
