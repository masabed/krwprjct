  ...
  <div class="card">
          ...
          <div class="col-md-7 col-3">
            <ul class="list-inline user-chat-nav text-end mb-0">
              <li class="list-inline-item">
                <BDropdown v-model="show" dropend toggle-class="nav-btn text-dark font-size-20" variant="white" menu-class="dropdown-menu-end dropdown-menu-md p-0">
                  <template #button-content> <i class="mdi mdi-magnify"></i> </template>
                  <form class="p-2">
              ...
              <li class="list-inline-item d-none d-sm-inline-block">
                <BDropdown v-model="show" dropend toggle-class="nav-btn text-dark font-size-20" variant="white" size="sm" menu-class="dropdown-menu-end p-0">
                  <template #button-content>  <i class="mdi mdi-cog"></i> </template>
                  <BDropdownItem href="#">View Profile</BDropdownItem>
                  <BDropdownItem href="#">Clear chat</BDropdownItem>
              ...
              <li class="list-inline-item">
                <BDropdown v-model="show" dropend toggle-class="nav-btn text-dark font-size-20" variant="white" size="sm" menu-class="dropdown-menu-end p-0">
                  ...
                  <BDropdownItem href="#">Something else</BDropdownItem>
                </BDropdown>
              </li>
            </ul>
          </div>
    ...
    <div class="card-body">
      <div class="chat-widget">
        <div class="chat-conversation">
          <simplebar style="max-height: 292px" ref="current" id="containerElement">
            <ul class="list-unstyled mb-0 pr-3" v-for="(data, index) in ChatData" :key="index" :class="{ right: `${data.align}` === 'right' }">
              <li v-if="!data.text">
                <div class="conversation-list">
                  ...
                  <div class="ctext-wrap">
                    ...
                    <p class="chat-time mb-0">
                      <i class="mdi mdi-clock-outline align-middle me-1"></i>
                      {{ data.time }}
                    </p>
                  </div>
                </div>
    ...
    <div class="p-3 chat-input-section border-top">
      <form @submit.prevent="formSubmit" class="row">
        <div class="col">
          <div>
            <input type="text" class="form-control rounded chat-input pl-3" placeholder="Enter Message..." v-model="chat.message" :class="{ 'is-invalid': submitted && $v.chat.message.$error }" />
