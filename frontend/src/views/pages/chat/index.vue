      ...
      <div class="chat-leftsidebar">
        <div class="p-3 border-bottom">
          <div class="d-flex">
            ...
            <div>
              <BDropdown variant="white" toggle-class="text-dark" class="chat-noti-dropdown" right menu-class="dropdown-menu-end">
        ...
        <div class="chat-left sidebar-nav">
                        ...
                        <a href="javascript: void(0);">
                          <div class="d-flex">
                            <div class="flex-shrink-0">
                              <div class="user-img align-self-center me-3" v-if="data.image" :class="{
                              ...
                              <div class="user-img me-3" v-if="!data.image" :class="{
                                online: `${data.status}` === 'online',
                                away: `${data.status}` === 'away',
                              }">
                                <div class="avatar-xs align-self-center">
                                  <span class="avatar-title rounded-circle bg-light text-body">{{ data.name.charAt(0) }}</span>
                                </div>
                                <span class="user-status"></span>
                              </div>
                            </div>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avatar-xs me-3">
                            <span class="avatar-title rounded-circle bg-light text-body">G</span>
                          </div>
                        </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avatar-xs me-3">
                            <span class="avatar-title rounded-circle bg-light text-body">R</span>
                          </div>
                        </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avatar-xs me-3">
                            <span class="avatar-title rounded-circle bg-light text-body">M</span>
                          </div>
                        </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avatar-xs me-3">
                            <span class="avatar-title rounded-circle bg-light text-body">A</span>
                          </div>
                        </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avatar-xs me-3">
                            <span class="avatar-title rounded-circle bg-light text-body">B</span>
                          </div>
                        </div>
            ...
            <div class="col-md-8 col-3">
              <ul class="list-inline user-chat-nav text-end mb-0">
                ...
                <li class="list-inline-item d-none d-sm-inline-block">
                  <BDropdown variant="white" toggle-class="nav-btn text-dark font-size-20" class="chat-noti-dropdown" right menu-class="dropdown-menu-end">
                    <template #button-content>
          ...
          <div class="px-lg-3">
            <div class="p-3 chat-input-section">
              <form @submit.prevent="formSubmit" class="row">
                <div class="col">
                  <div class="position-relative">
                    <input type="text" v-model="form.message" class="form-control chat-input" placeholder="Enter Message..." />
                  </div>
                </div>
                <div class="col-auto">
