          ...
          <div class="timeline-item timeline-left">
            <div class="timeline-block">
              <div class="time-show-btn mt-0">
                <a href="#" class="btn btn-danger btn-rounded w-lg">2024</a>
              </div>
            </div>
          </div>

          <div class="timeline-item" v-for="(data, index) in timelineData" :key="index" :class="{ 'timeline-left': `${data.align}` === 'left' }">
            <div class="timeline-block">
