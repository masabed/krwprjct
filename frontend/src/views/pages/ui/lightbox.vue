...
import sImg1 from "@/assets/images/small/img-1.jpg"
...
import sImg6 from "@/assets/images/small/img-6.jpg"
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="popup-gallery">
              <a class="float-start" v-for="(item, index) in lightboximgs" :key="index" @click="() => showImg(index)">
                <div class="img-fluid">
      ...
      <div class="col-xl-6">
            ...
            <div class="row">
              <div class="col-12">
                <div class="button-items">
                  ...
                  <b-modal class="dark-video-modal" id="modal-1" hide-footer size="lg" centered header-close-variant="white" modal-class="video-modal">
                    <youtube video-id="RnDC9MXSqCY" ref="youtube" width="750" height="450"></youtube>
                  </b-modal>

                  <a class="popup-vimeo btn btn-light mo-mb-2" href="https://vimeo.com/45830194">Open Vimeo Video</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div>
              <a class="popup-form btn btn-primary" href="javascript: void(0);" v-b-modal.popup-form>Popup form</a>
            </div>
