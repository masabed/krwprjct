        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="media mb-4">
              <img class="avatar-sm me-3 rounded-circle" src="@/assets/images/users/avatar-6.jpg" alt />
            ...
            <div class="media mb-4">
              <img class="avatar-sm me-3 rounded-circle" src="@/assets/images/users/avatar-2.jpg" alt />
              <div class="media-body">
            ...
            <div class="media">
              ...
              <img class="avatar-sm ms-3 rounded-circle" src="@/assets/images/users/avatar-4.jpg" alt />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="media mb-4">
              <img class="avatar-sm align-self-start rounded me-3" src="@/assets/images/users/avatar-3.jpg" alt />
              <div class="media-body">
            ...
            <div class="media mb-4">
              <img class="avatar-sm align-self-center rounded me-3" src="@/assets/images/users/avatar-5.jpg" alt />
              <div class="media-body">
            ...
            <div class="media">
              <img class="avatar-sm align-self-end rounded me-3" src="@/assets/images/users/avatar-1.jpg" alt />
              <div class="media-body">
