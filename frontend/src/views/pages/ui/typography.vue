        ...
        <div class="card">
          <div class="card-body">
            ...
            <h1 class="mb-3">
              ...
              <small class="text-muted">Semibold 2.0325rem (32.52px)</small>
            </h1>
            <h2 class="mb-3">
              h2. Bootstrap heading
              <small class="text-muted">Semibold 1.626rem (26.016px)</small>
            </h2>
            <h3 class="mb-3">
              h3. Bootstrap heading
              <small class="text-muted">Semibold 1.42275rem (22.764px)</small>
            </h3>
            <h4 class="mb-3">
              h4. Bootstrap heading
              <small class="text-muted">Semibold 1.2195rem (19.512px)</small>
            </h4>
            <h5 class="mb-3">
              h5. Bootstrap heading
              <small class="text-muted">Semibold 1.01625rem (16.26px)</small>
            </h5>
            <h6 class="mb-3">
              h6. Bootstrap heading
              <small class="text-muted">Semibold 0.813rem (13.008px)</small>
            </h6>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title-desc">
              ...
              light
              <code class="highlighter-rouge">margin</code> with a combination
              of two classes,
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title-desc">
              ...
              <code class="highlighter-rouge">.text-truncate</code> class to
