      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <BTabs content-class="p-3 text-muted">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <BTabs pills justified content-class="p-3 text-muted">
              <BTab active class="border-0">
                <template #title>
                  <span class="d-inline-block d-sm-none">
                    <i class="fas fa-home"></i>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <BTabs pills vertical nav-class="p-0" nav-wrapper-class="col-sm-3" content-class="pt-0 px-2 text-muted">
              <BTab title="Home" active title-item-class="mb-2">
                <BCardText>{{ text }}</BCardText>
              </BTab>
              <BTab title="Profile" title-item-class="mb-2">
                <BCardText>{{ content }}</BCardText>
              </BTab>
              <BTab title="Messages" title-item-class="mb-2">
                <BCardText>{{ text }}</BCardText>
              </BTab>
              <BTab title="Settings">
                <BCardText>{{ content }}</BCardText>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <BButton v-b-toggle.collapse class="m-1" variant="primary">Link with href</BButton>

            <!-- Using value -->
            <BButton v-b-toggle="'collapse'" class="m-1" variant="primary">Button with data-target</BButton>

            <!-- Element to collapse -->
            <BCollapse id="collapse" visible class="mt-1">
              <BCard>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.</BCard>
            </BCollapse>
          </div>
        </div>
      </div>
            ...
            <div role="tablist">
              <BCard no-body class="mb-1 shadow-none">
                <BCardHeader header-tag="header" role="tab">
                  <h6 class="m-0">
                    <a v-b-toggle.accordion-1 class="text-dark" href="javascript: void(0);">Collapsible Group Item #1</a>
                  </h6>
                </BCardHeader>
              ...
              <BCard no-body class="mb-1">
                <BCardHeader header-tag="header" role="tab">
                  <h6 class="m-0">
                    <a v-b-toggle.accordion-2 class="text-dark" href="javascript: void(0);">Collapsible Group Item #2</a>
                  </h6>
                </BCardHeader>
              ...
              <BCard no-body class="mb-1">
                <BCardHeader header-tag="header" role="tab">
                  <h6 class="m-0">
                    <a v-b-toggle.accordion-3 class="text-dark" href="javascript: void(0);">Collapsible Group Item #3</a>
                  </h6>
                </BCardHeader>
