            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="p-3">
                  ...
                  <div class="px-3">
                    <Slider v-model="loadingValue" :show-tooltip="true" :is-disabled="true" />
                    <br />
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="p-3">
                  ...
                  <div class="px-3">
                    <Slider v-model="customStyle" :min="100" :max="1000" :line-height="lineHeight" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="p-3">
                  ...
                  <div class="px-3">
                    <Slider :data="customData.data" :range="customData.range" />
                  </div>
                </div>
              </div>
            </div>
