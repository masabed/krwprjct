      ...
      <div class="col-lg-6">
        <div class="text-lg-end">
          <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item">
              <a href="javascript: void(0);" class="d-inline-block" v-b-tooltip.hover title="Jonathan McKinney">
                <div class="avatar-xs">
          ...
          <div class="card-body border-bottom">
            <div id="todo-task" class="task-list">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-inline-flex team mb-0">
                      ...
                      <div class="team-member">
                        <a href="javascript: void(0);" class="team-member d-inline-block" v-b-tooltip.hover data-placement="top" title="Calvin Redrick">
                          <img :src="`${task.user[0]}`" class="rounded-circle avatar-xs" alt />
                        </a>
                      </div>

                      <div class="team-member">
                        <a href="javascript: void(0);" class="team-member d-inline-block" v-b-tooltip.hover data-placement="top" title="David Martinez" v-if="task.user[1]">
              ...
              <div class="text-center">
                <a href="javascript: void(0);" class="btn btn-primary mt-1 waves-effect waves-light">
          ...
          <div class="card-body border-bottom">
            <div id="inprogress-task" class="task-list">
              <draggable class="list-group" group="tasks" :list="progressTasks">
                <div class="card task-box" v-for="task in progressTasks" :key="task.id">
                  <div class="progress progress-sm animated-progess" style="height: 3px">
                    <div class="progress-bar" role="progressbar" style="width: 72%" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <div class="card-body">
          ...
          <div class="card-body border-bottom">
            <div id="inprogress-task" class="task-list">
              <draggable class="list-group" group="tasks" :list="completedTasks">
                <div class="card task-box" v-for="task in completedTasks" :key="task.id">
                  <div class="progress progress-sm animated-progess" style="height: 3px">
                    <div class="progress-bar" role="progressbar" style="width: 72%" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="d-inline-flex team mb-0">
                      <div class="me-3 align-self-center">Team :</div>
                      <div class="team-member">
                        <a href="javascript: void(0);" class="team-member d-inline-block" v-b-tooltip.hover title="Calvin Redrick">
                          <img :src="`${task.user[0]}`" class="rounded-circle avatar-xs" alt />
                        </a>
                      </div>

                      <div class="team-member">
                        <a href="javascript: void(0);" class="team-member d-inline-block" v-b-tooltip.hover title="David Martinez" v-if="task.user[1]">
                          <img :src="`${task.user[1]}`" class="rounded-circle avatar-xs" alt />
                        </a>
                      </div>
                    </div>
