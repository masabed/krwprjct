                    ...
                    <div>
                      ...
                      <div class="p-2 mt-5">
                        <form class="form-horizontal">
                          ...
                          <div class="mt-4 text-center">
                            <router-link tag="a" to="/auth/recoverpwd-1" class="text-muted">
                      ...
                      <div class="mt-5 text-center">
                        <p>
                          ...
                          <router-link tag="a" to="/auth/register-1" class="font-weight-medium text-primary">Register</router-link>
                        </p>
                        <p>
