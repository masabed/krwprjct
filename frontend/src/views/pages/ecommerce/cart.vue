              ...
              <table class="table table-centered mb-0 table-nowrap">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 text-truncate">
                        <router-link to="/ecommerce/product-detail" class="text-dark">Full sleeve T-shirt</router-link>
                      </h5>
                      <p class="mb-0">
                        Color :
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 text-truncate">
                        <router-link to="/ecommerce/product-detail" class="text-dark">Half sleeve T-shirt</router-link>
                      </h5>
                      <p class="mb-0">
                        Color :
                        <span class="font-weight-medium">Red</span>
                      </p>
                    </td>
                    <td>$ 225</td>
                    <td>1</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 text-truncate">
                        <router-link to="/ecommerce/product-detail" class="text-dark">Hoodie (Green)</router-link>
                      </h5>
                      <p class="mb-0">
                        Color :
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 text-truncate">
                        <router-link to="/ecommerce/product-detail" class="text-dark">Hoodie (Gray)</router-link>
                      </h5>
                      <p class="mb-0">
                        Color :
                        <span class="font-weight-medium">Gray</span>
                      </p>
                    </td>
                    <td>$ 275</td>
                    <td>1</td>
