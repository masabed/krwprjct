   ...
   public function index()
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success'=>true,'message'=>'Data tersimpan','data'=>$row], 201);
    }
    ...
    public function update(Request $request, string $uuid)
    {
        ...
        return response()->json(['success'=>true,'message'=>'Data diperbarui','data'=>$row->fresh()]);
    }
